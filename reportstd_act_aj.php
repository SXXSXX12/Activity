...
WHERE a.year1='$year' OR a.year2='$year' OR a.year3='$year' OR a.year4='$year'";
                    ...
                    $result2 = mysqli_query($conn, "SELECT CONCAT(s.fname,' ',s.lname) AS fullname,SUM(a.act_hour) as hour_total 
FROM activity a 
                ...
                <table width='100%' align='center'>
                    ...
                    while ($rs = mysqli_fetch_array($result)) {//ใช้วนจนครบแถวในarray
                        ...
                        <tr>
                            ...
                            <td align='center'><a href='act_card.php?his_id=<?= $rs['his_id'] ?>' target="_blank"><img src="images/printer.ico" width="35" height="35"></a></td>
                        </tr>
                    <?php } ?>
