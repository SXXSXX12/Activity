...
<center><ul class="actions">
        ...
        <li><a href="data_student.php" class="button special" title="ข้อมูลนักศึกษา">Student Data</a></li>
...
echo mysqli_error($conn);
                    ...
                    while ($rs = mysqli_fetch_array($qr)) {
                        ...
                        <tr>
                            ...
                            <td align='center'><a href='add_stddata.php?std_id=<?php echo $rs['std_id']; ?>&method=edit' title="แก้ไขข้อมูลนักศึกษา"><img src="images/din.png" width="40" height="40"></a></td>
                            <td align='center'><a href='data_student.php?std_id=<?php echo $rs['std_id']; ?>&method=delete' onclick="return confirm('คุณต้องการลบ?')" title="ลบข้อมูลนักศึกษา"><img src="images/2.png" width="40" height="40"></a></td>
